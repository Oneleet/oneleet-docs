...
<Tabs items={["macOS", "Windows", "Linux"]}>
  <Tabs.Tab>
    When running, the Oneleet Agent appears as a clickable Oneleet icon in your macOS menu
    bar at the top right of your screen. If you started the Oneleet Agent but don't see the Oneleet icon
    in your menu bar, see the [I can't see the Oneleet icon in my menu bar](/oneleet-agent/troubleshooting#i-cant-see-the-oneleet-icon-in-my-menu-bar) section in our Troubleshooting guide.

    ![macOS menu bar](/oneleet-agent/macos-menu-bar.png)

  </Tabs.Tab>
  <Tabs.Tab>
    When running, the Oneleet Agent appears as a clickable Oneleet icon in your Windows
