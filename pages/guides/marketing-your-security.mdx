...
**If these examples are too generic and you'd like more tailored suggestions, message us and we'll provide customized examples and copy!** Let us know when you post and we can repost them across our channels.

<Tabs items={['Stage 1: Starting out', 'Stage 2: In progress', 'Stage 3: Completed', 'And beyond...']}>
<Tabs.Tab>
...
- **What to do:** Once onboarded to the Oneleet platform, set up and publish your customizable Trust Center. You can add a link to the Trust Center on your Landing Page to show your ongoing commitment to security.
- **How to implement:** Include this achievement in your newsletter, share the page on LinkedIn and other socials.

**Post Examples**
    
    > "We're excited to share our new Trust Center! This is where you'll find all the latest updates on how we protect your data and ensure compliance. Check it out [link to Trust Center]!"
    
    > "We're taking the first steps in our compliance journey with the goal of keeping your data safer than ever. Check out our Trust Center to learn more [link to Trust Center]!"
    
    > "Transparency is key to trust! Explore our new Trust Center to see the measures we’re taking to protect your data and uphold the highest compliance standards. [link to Trust Center]"
    
    > "Your security is our priority. Visit our Trust Center to learn how we’re building a safer, more compliant future for your data. [link to Trust Center]" 
...
- **Where to put it:** Place the badge in the footer of your website, Trust Center or on a dedicated security page.
- **How to add it:**
...
If you’re fundraising and would like to add a slide to your pitch deck outlining your security program, reach out to the Oneleet team and **we’ll create a tailored slide** for you.
...
- **Add document to your Trust Center:**
    
    Enhance transparency by uploading key documents, like your penetration test report, to the document section of your Trust Center.
    ...
    5. Done! (If you’d like to change the title of the document, update its name in your Evidence library)
...
### Showcase progress on your Trust Center
...
- **Example phrasing for posts:**
    ...
    > "Transparency matters. We’ve updated our Trust Center with the latest milestones, such as [specific measures], to keep you informed."

    > "We’ve reached new heights in safeguarding your data by implementing [specific measures]. Explore more on our Trust Center."

    > "Our compliance journey continues! Check out the Trust Center for updates on key achievements like [specific measures]."

    > "Keeping your data safe is our top priority. Learn more about our recent milestones, including [specific measures], on our Trust Center."
...
In this official announcement, you can choose many routes to promote your achievement. Whether you want to post on your socials, include it in your newsletter, email your users, or post a blog/article about it. Below are a few examples of how to promote your milestone.
...
- **Email body example templates:**
    ...
    >
    > Want to learn more about what this means for you? Check out our blog post [link to blog] or visit our Trust Center [link to Trust Center].
    >
    > Best regards,
    > [Your Name]
    > [Your Company]
    ...
    >    
    > Check out more details on our website here: [link to blog or Trust Center].
    >    
    ...
    > 
    > Learn more about how this benefits you and what’s next for [Your Company] in our [blog post or trust center] here: [link].
    > 
...
- **Outline example**
    ...
    6. **Call to Action:** Encourage customers to reach out with any questions or learn more on your Trust Center. You might also invite them to share the news on social media or subscribe for future updates.
...
- **Showcase Your Growth:** Keep your audience informed about your ongoing commitment to security with regular updates on your Trust Center or through social media. 
