...
## What is a VPC?
Virtual Private Clouds are virtual networks in GCP, they are most commonly used to allow services to communicate with each other. VPCs allow you to control access to services and resources you host on GCP, the firewall and routing systems prevent unauthorized network access.
