...
- https://www.googleapis.com/auth/admin.directory.customer.readonly - Directory API read-only access to customer information
- https://www.googleapis.com/auth/cloud-identity.policies.readonly - Cloud Identity API read-only access to policies
