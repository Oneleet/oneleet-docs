...
At present, custom-built integrations can gather users to automatically populate a vendor for access reviews. We recommend trying the integration builder if you have a large number of accounts that would otherwise be tedious to input by hand. Please note the following other limitations at this time:

- only API Key-based based authentication is supported;
...
### [4/5] Specify the pagination strategy
...
- **Link-based** – respones include a URL that should be queried to retrieve the next page
...
### [5/5] Map fields to user properties
