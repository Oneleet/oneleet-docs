...
You should soon see a GitHub notification prompting you to accept new permissions for the **Oneleet** app. Please accept the permissions to enable user access reviews for GitHub on Oneleet.
