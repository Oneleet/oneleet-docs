...
We're enhancing our Amazon Web Services integration to improve the scope and reliability of our monitoring. As part of this change, we will soon require the following **additional permissions** on your IAM role for Oneleet:
